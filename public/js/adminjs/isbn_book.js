...
function loadDauSachForEdit(dauSach) {
    ...
    console.log('Tác giả hiện tại:', Array.isArray(dauSach.MATACGIA));
    if (dauSach.MATACGIA && Array.isArray(dauSach.MATACGIA)) {
        Array.from(tacGiaSelect.options).forEach(option => {
            option.selected = dauSach.MATACGIA.includes(option.value);
        });
...
$(document).ready(function () {
    ...
    $('#confirmEditDauSachBtn').on('click', function() {
        ...
        formData.append('maTacGia', selectedTacGia);
